		...
		<form class="needs-validation" novalidate=""  action="" method="post" id="readCheck">
			...
			<div class="row">
				...
				<div class="col-md-4 order-md-2 mb-4">
					...
					<!-- 북마크 수정 추가 -->
					<c:if test="${user eq 'bookmarker' }">
					<button class="btn btn-primary" id="bookUpdateBtn" style="width: 50%;" value="${checklist.checkNo}">북마크 수정하기</button><button class="btn btn-secondary" style="width: 50%;">북마크 삭제하기</button>
					<br><br>
					<button class="btn btn-danger" id="repBtn" style="width: 100%;"
					value="${checklist.checkNo}">신고하기</button>							
					</c:if>
